...
<html>
	...
	<header>
		...
		<form name="myform" method='post' action='editUserResult' onSubmit="return check()" id="log"><br>
		    ID(英数字)<br><input type='text' maxlength='15' pattern="^[0-9A-Za-z]+$" title="半角英数字を入力して下さい。" name='id' required value="${sessionScope.loginuser.id}"  autofocus>${result.message}<br><br>
