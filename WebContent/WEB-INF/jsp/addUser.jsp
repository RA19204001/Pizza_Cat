...
<form name="myform" method='post' action='addUserResult' onSubmit="return check()"  id="log">
    ...
    名前<br><input type='text' maxlength='20' placeholder="例）ピザキャト子" name='name' required><br><br>
    住所<br><input type='text' maxlength='50' placeholder="例）東京都〇〇区〇〇〇-〇-〇" name='address' required><br><br>
    年齢<br><input type='text' maxlength='3' placeholder="例）20" pattern="^[0-9]+$" title="半角数字で入力して下さい。" name='age' required><br><br>
